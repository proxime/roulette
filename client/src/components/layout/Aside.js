    ...
    <>
      ...
      {user && user.nick && (
        <div className="leftbar__user-buttons">
          <RefreshLink to="/dashboard" className="leftbar__avatar">
            <div
              className="leftbar__avatar-image"
              style={{ backgroundImage: `url(avatars/${user.avatar})` }}
            ></div>
          </RefreshLink>
          <RefreshLink to="/dashboard" className="leftbar__nick">
            {user.nick}
          </RefreshLink>
        </div>
      )}
  ...
  const guestLinks = (
    <>
      ...
      <div className="leftbar__login-buttons">
        <div className="leftbar__register-btn">
          <RefreshLink to="/register">Rejestracja</RefreshLink>
        </div>
        <div className="leftbar__login-btn">
