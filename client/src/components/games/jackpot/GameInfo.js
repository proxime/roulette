        ...
        <div className="jackpot__info">
            ...
            <div className="jackpot__info-container">
                <div className="jackpot__info-line">
                    Pula: <span className="jackpot__info-cash">{jackpot.cash} <i className="fas fa-coins"></i></span></div>
                <div className="jackpot__info-line">Liczba Graczy: {jackpot.players.length}</div>
