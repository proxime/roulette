...
import { setUpBet, updateJackpot, endGame, updateJackpotGames } from '../../actions/jackpot';
...
const Jackpot = ({ auth, history, jackpotMessages, setJackpotMessages, setUpBet, clearAlerts, updateJackpot, jackpot, endGame, updateJackpotGames }) => {
    ...
    const typeOnChat = (e) => {
        ...
        if (!textarea) return;
        if (!auth.isAuthenticated) history.push('/login');
        if (!auth.user.nick) history.push('/dashboard');
                    ...
                    <div className="jackpot__body">
                        <div className="jackpot__section">
                            <div className="jackpot__add-bet">
                                ...
                                <form onSubmit={e => onSubmit(e)} className="jackpot__add-bet-form">
                                    <TextInput
                                        type="number"
                                        name="luckycoins"
                                        onchange={onChange}
...
export default connect(mapStateToProps, { setJackpotMessages, setUpBet, clearAlerts, updateJackpot, endGame, updateJackpotGames })(withRouter(Jackpot));