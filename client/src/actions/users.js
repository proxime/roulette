...
import { UPDATE_USER, UPDATE_FAIL, DELETE_ACCOUNT, REFRESH_USER, REFRESH_FAIL } from './types';
...
// Update User
export const updateUser = ({ nick, name, email }, history) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json'
        }
...
// Change Password
export const changePassword = (history, password, newPassword) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json'
        }
